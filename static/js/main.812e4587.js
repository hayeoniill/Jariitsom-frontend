...
`,Qs=to.button`
 ...
 &:first-child {
  ...
  }`;const Ys=function(e){let{onClose:t,onConfirm:n}=e;return(0,so.jsx)(Ws,{children:(0,so.jsxs)(Ks,{children:[(0,so.jsx)(qs,{src:"/images/Logo/logoText.svg"}),(0,so.jsx)(Vs,{children:"\ub85c\uadf8\uc544\uc6c3 \ud558\uc2dc\uaca0\uc2b5\ub2c8\uae4c?"}),(0,so.jsxs)(Js,{children:[(0,so.jsx)(Qs,{onClick:t,children:"\uc544\ub2c8\uc624"}),(0,so.jsx)(Qs,{onClick:n,children:"\uc608"})]})]})})},Gs=to.div`
  position: fixed;
  top: 0; left: 0;
  width: 100vw; height: 100vh;
  background: rgba(0, 0, 0, 0.3);
